...
/**
 * A variation of Quicksort algorithm using a random pivot with a cut of to
 * insertion sort at 6 which was arbitrarily chosen.
 * @author Mahadi Ahmed
 *
 */
...
public class QuicksortRandomPivotInsertion implements IntSorter {
	...
	public static void main(String[] args) {
		QuicksortRandomPivotInsertion t = new QuicksortRandomPivotInsertion();
